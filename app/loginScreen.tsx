	...
	return (
		<>
			...
			<View className="flex-1 justify-center items-center bg-primary-green px-5">
				...
				/>
				<Text className="text-4xl font-bold mb-6 text-primary-yellow">
					Login
				</Text>
				...
				/>
				{passwordError ? (
					<Text className="text-red-500 font-semibold mb-5">
						{passwordError}
					</Text>
				) : null}
				...
				<TouchableOpacity
					...
					onPress={handleLogin}
				>
					<Text className="text-highlight-black text-lg font-bold">
						Login
					</Text>
				</TouchableOpacity>

				<TouchableOpacity className="mt-4">
					<Text className="text-highlight-grey text-base">
						Forgot Password?
					</Text>
				</TouchableOpacity>
			</View>
