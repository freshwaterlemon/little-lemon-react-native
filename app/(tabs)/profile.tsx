		...
		useCallback(() => {
			const fetchData = async () => {
				try {
					...
					const storedPhonenum = await AsyncStorage.getItem(
						'userPhonenum'
					);
			...
			<View className="flex-1 px-5 py-5 items-center bg-white">
				<View className="w-full p-6 mx-8">
					...
					<View className="flex-row py-3 items-center">
						...
						<Text className="text-3xl font-semibold mx-2 mt-4">
					...
					>
						<Text className="text-highlight-grey text-xl font-bold">
							Update Profile
						</Text>
					</TouchableOpacity>
				</View>
				...
				<View className="w-full px-6 mx-8">
					<Text className="text-2xl text-red-500 font-bold mb-4">
						Danger Zone
					</Text>
					<TouchableOpacity
